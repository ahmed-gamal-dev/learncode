    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                @if (strtolower(auth()->user()->email) === 'admin@app.com')

                <li class="nav-item">
                    <a class="nav-link active" href="#navbar-admins" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-admins">
                        <i class="fa fa-user-secret" style="color: #f4645f;"></i>
                        <span class="nav-link-text" style="color: #f4645f;">{{ __('Admin') }}</span>
                    </a>

                    <div class="collapse show" id="navbar-admins">
